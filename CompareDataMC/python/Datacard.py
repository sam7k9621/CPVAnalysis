...
mclst =[
     ...
     [ "ttbar_semi",                   "TTToSemiLeptonic_CP5Nom",    831.76 * 0.44113 ],
     [ "ttbar_dilep",                  "TTTo2L2Nu_CP5Nom",                  831.76 * 0.10706 ],
     [ "ttbar_had",                    "TTToHadronic",               831.76 * 0.45441 ],
 
     [ "ttbar_semi_mtop1695",          "TTToSemiLeptonic_CP5mtop1695", 831.76 * 0.44113           ],
     [ "ttbar_semi_mtop1755",          "TTToSemiLeptonic_CP5mtop1755", 831.76 * 0.44113           ],
     [ "ttbar_semi_hdampDOWN",         "TTToSemiLeptonic_hdampDOWN",   831.76 * 0.44113           ],
     [ "ttbar_semi_hdampUP",           "TTToSemiLeptonic_hdampUP",     831.76 * 0.44113           ],
     [ "ttbar_semi_CP5CR1",            "TTToSemiLeptonic_CP5CR1",      831.76 * 0.44113           ],
     [ "ttbar_semi_CP5CR2",            "TTToSemiLeptonic_CP5CR2",      831.76 * 0.44113           ],
     [ "ttbar_semi_CP5down",           "TTToSemiLeptonic_CP5down",     831.76 * 0.44113           ],
     [ "ttbar_semi_CP5up",             "TTToSemiLeptonic_CP5up",     831.76 * 0.44113           ],

     [ "ttbar_dilep_mtop1695",         "TTTo2L2Nu_mtop1695", 831.76 * 0.10706           ],
     [ "ttbar_dilep_mtop1755",         "TTTo2L2Nu_mtop1755", 831.76 * 0.10706           ],
     [ "ttbar_dilep_mtop1695",         "TTTo2L2Nu_mtop169p5", 831.76 * 0.10706           ],
     [ "ttbar_dilep_mtop1755",         "TTTo2L2Nu_mtop175p5", 831.76 * 0.10706           ],
     [ "ttbar_dilep_hdampDOWN",        "TTTo2L2Nu_hdampDOWN",   831.76 * 0.10706           ],
     [ "ttbar_dilep_hdampUP",          "TTTo2L2Nu_hdampUP",     831.76 * 0.10706           ],
     [ "ttbar_dilep_CP5CR1",           "TTTo2L2Nu_CP5CR1",      831.76 * 0.10706           ],
     [ "ttbar_dilep_CP5CR2",           "TTTo2L2Nu_CP5CR2",      831.76 * 0.10706           ],
     [ "ttbar_dilep_CP5down",          "TTTo2L2Nu_CP5down",     831.76 * 0.10706           ],
     [ "ttbar_dilep_CP5up",            "TTTo2L2Nu_CP5up",       831.76 * 0.10706           ],
     
     [ "ttbar_dtg0",                   "TT_CEDM_dtG0",                 482.5            ],
     [ "ttbar_dtg1",                   "TT_CEDM_dtG1",                 497.6            ],
     [ "ttbar_dtg2",                   "TT_CEDM_dtG2",                 581.5            ],
     [ "ttbar_dtg3",                   "TT_CEDM_dtG3",                 715.9            ],
     [ "ttbar_dtg4",                   "TT_CEDM_dtG4",                 939.6            ],
     [ "ttbar_dtg5",                   "TT_CEDM_dtG5",                 1196             ],
     [ "VV_WW",                        "WW",                           118.7            ],
     [ "VV_WZ",                        "WZ",                           47.13            ],
     [ "VV_ZZ",                        "ZZ",                           16.52            ],
