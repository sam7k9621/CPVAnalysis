...
def main(args):
    ...
    for sample, tag in samplelst:
        if tag[0] == 1:
            content[ tag[1] ] = { "path" : opt.dir + sample[1] + "/*.root" }
        elif tag[0] == 2:
            content[ tag[1] + "_1" ] = { "path" : opt.dir + sample + "/*[0-5].root" }
            content[ tag[1] + "_2" ] = { "path" : opt.dir + sample + "/*[6-9].root" }
        elif tag[0] == 5:
            content[ tag[1] + "_1" ] = { "path" : opt.dir + sample + "/*[0-1].root" }
            content[ tag[1] + "_2" ] = { "path" : opt.dir + sample + "/*[2-3].root" }
            content[ tag[1] + "_3" ] = { "path" : opt.dir + sample + "/*[4-5].root" }
            content[ tag[1] + "_4" ] = { "path" : opt.dir + sample + "/*[6-7].root" }
            content[ tag[1] + "_5" ] = { "path" : opt.dir + sample + "/*[8-9].root" }
        else:
