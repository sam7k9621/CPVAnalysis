...
process.Jet = cms.PSet(
        JerUpdate  = cms.bool( False ),
        Jesfile    = cms.string( "" ),
        Jerfile    = cms.string( "" ),
        
        JecUpdate  = cms.bool( True ),
        Resfile    = cms.string( "/wk_cms2/sam7k9621/CMSSW_10_2_17/src/CPVAnalysis/BaseLineSelector/data/Autumn18_RunD_V19_DATA_L2L3Residual_AK4PFchs.txt" ),     
        L1file     = cms.string( "/wk_cms2/sam7k9621/CMSSW_10_2_17/src/CPVAnalysis/BaseLineSelector/data/Autumn18_RunD_V19_DATA_L1FastJet_AK4PFchs.txt" ),
        L2file     = cms.string( "/wk_cms2/sam7k9621/CMSSW_10_2_17/src/CPVAnalysis/BaseLineSelector/data/Autumn18_RunD_V19_DATA_L2Relative_AK4PFchs.txt" ),
        L3file     = cms.string( "/wk_cms2/sam7k9621/CMSSW_10_2_17/src/CPVAnalysis/BaseLineSelector/data/Autumn18_RunD_V19_DATA_L3Absolute_AK4PFchs.txt" ),
        JecUncfile = cms.string( "/wk_cms2/sam7k9621/CMSSW_10_2_17/src/CPVAnalysis/BaseLineSelector/data/Autumn18_RunD_V19_DATA_Uncertainty_AK4PFchs.txt" ),
        
        JecSrcUpdate  = cms.bool( False ),
        JecSrcfile = cms.string( "" ),
