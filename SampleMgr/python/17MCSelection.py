...
process.Jet = cms.PSet(
        ...
        JecUpdate  = cms.bool( False ),
        Resfile    = cms.string( "" ),
        L1file     = cms.string( "" ),
        L2file     = cms.string( "" ),
        L3file     = cms.string( "" ),
        JecUncfile = cms.string( "" ),
        
        JecSrcUpdate  = cms.bool( True ),
        JecSrcfile = cms.string( "/wk_cms2/sam7k9621/CMSSW_10_2_17/src/CPVAnalysis/BaseLineSelector/data/Fall17_17Nov2017_V32_MC_UncertaintySources_AK4PFchs.txt" ),
        ...
        DeepCSVL = cms.double( 0.1522 ),
        DeepCSVM = cms.double( 0.4941 )
        )
