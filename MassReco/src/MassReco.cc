...
extern bool
passChi2Upper( const double& chi2, const double& upper )
{
...
extern bool
isIsolated( const int& muidx, const int& jetidx )
{
    return SelMgr().isIsoLepton( muidx, jetidx );
}

extern bool
passFullJet( vector<int>& jetidx, vector<int>& bjetidx, const int& muidx )
{
...
extern bool
passMCJet( vector<int>& jet, vector<int>& bjet )
{
...
extern bool
hasCommonT_lep( const int& bjetidx, const int& lepidx )
{
