...
./SubmitJob.py -C "FullCut -y $1 -l $2" -S mc -E CEDM
#./SubmitJob.py -C "FullCut -y $1 -l mu -r WJets_0b" -S mu mc 
#./SubmitJob.py -C "FullCut -y $1 -l mu -r WJets_1b" -S mu mc 
...
#./SubmitJob.py -C "FullCut -y $1 -l el -r WJets_0b" -S el mc 
#./SubmitJob.py -C "FullCut -y $1 -l el -r QCD_0b" -S el mc 
...
##return
./SubmitJob.py -C "FullCut -y $1 -l $2 -e JER_up" -S mc -E CEDM
./SubmitJob.py -C "FullCut -y $1 -l $2 -e JER_dn" -S mc -E CEDM
./SubmitJob.py -C "FullCut -y $1 -l $2 -e JEC_up" -S mc -E CEDM
./SubmitJob.py -C "FullCut -y $1 -l $2 -e JEC_dn" -S mc -E CEDM
